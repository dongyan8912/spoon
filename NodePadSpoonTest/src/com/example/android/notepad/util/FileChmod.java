 ...
 */
abstract class FileChmod {
    private static final FileChmod INSTANCE;
    ...
    private static class Java5Chmod extends FileChmod {
        @Override
    ...
    private static class Java6Chmod extends FileChmod {
        @Override
        protected void plusR(File file) {
